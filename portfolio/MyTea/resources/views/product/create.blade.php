...
<div class="container mt-20">
    <form action="{{route('product.store')}}" method="POST" enctype="multipart/form-data" style="width:400px">
        ...
        <input type="text" name="name" class="border-b border-black" value="{{ old('name') }}" style="width:400px"><br><br>
        @error('name') <p class="text-red-500">{{ $message }}</p> @enderror
        <h4 class="text-2xl mb-5">description</h4>
        <input type="text" name="description" class="border-b border-black" value="{{ old('description') }}" style="width:400px"><br><br>
        @error('description') <p class="text-red-500">{{ $message }}</p> @enderror
        <h4 class="text-2xl mb-5">price</h4>
        <input type="number" name="price" class="border-b border-black" value="{{ old('price') }}" style="width:400px"><br><br>
        ...
        <button type="submit" class="bannerBtn border border-black text-2xl" style="width:400px">Добавить</button>
